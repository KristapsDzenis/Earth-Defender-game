...
background_3 = pygame.image.load("assets/mars.jpg")
...
mothership = pygame.transform.rotate((pygame.image.load("assets/mothership.png")), 90)
mothership_2 = pygame.transform.rotate((pygame.image.load("assets/mothership_2.png")), 90)
